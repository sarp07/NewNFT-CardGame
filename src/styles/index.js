const styles = {
  ...
  infoText: 'font-rajdhani font-medium text-lg text-[#3aa2d7] cursor-pointer',
  ...
  hocLogo: 'flex flex-row object-contain cursor-pointer sm:w-[120px] w-full mr-2',
  hocBodyWrapper: 'flex-1 flex justify-center flex-col xl:mt-0 my-16',
  logoContainBox: 'flex items-center', // yeni özellik eklendi
  // medya sorgusu burada
  logoText: 'font-rajdhani',
  '@media (max-width: 640px)': {
    logoText: 'font-rajdhani font-medium text-2xl opacity-0',
  },
  ...
  btn: 'px-4 py-2 rounded-lg bg-[#3aa2d7] hover:bg-[#ffc107] transition-all ease-in duration-300 w-fit text-white font-rajdhani font-bold',

  // custom input component
  label: 'font-rajdhani font-semibold text-2xl text-white mb-3',
  input: 'bg-siteDimBlack text-white outline-none focus:outline-[#3aa2d7] p-4 rounded-md sm:max-w-[50%] max-w-full',
  ...
  gameLoadVS: 'font-rajdhani font-extrabold text-[#3aa2d7] text-7xl mx-16',

  // gameInfo component
  gameInfoIconBox: 'absolute right-2 top-1/2',
  gameInfoIcon: 'bg-[#3aa2d7] hover:bg-[#ffc107] transition-all ease-in duration-300 w-10 h-10 rounded-md cursor-pointer',
  ...
  gameInfoSidebarClose: 'w-10 h-10 rounded-md bg-[#3aa2d7] hover:bg-[#ffc107] transition-all ease-in duration-300 text-white font-rajdhani font-extrabold text-xl cursor-pointer',
